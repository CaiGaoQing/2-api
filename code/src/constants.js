...
export const MODEL_PRICING = {
    ...
    // Grok 模型定价（逆向接口，无实际费用）
    'grok-3': { input: 0, output: 0 },
    'grok-3-mini': { input: 0, output: 0 },
    'grok-3-thinking': { input: 0, output: 0 },
    'grok-4': { input: 0, output: 0 },
    'grok-4-mini': { input: 0, output: 0 },
    'grok-4-thinking': { input: 0, output: 0 },
    'grok-4-heavy': { input: 0, output: 0 },
    'grok-4.1-mini': { input: 0, output: 0 },
    'grok-4.1-fast': { input: 0, output: 0 },
    'grok-4.1-expert': { input: 0, output: 0 },
    'grok-4.1-thinking': { input: 0, output: 0 },
    'grok-4.20-beta': { input: 0, output: 0 },
